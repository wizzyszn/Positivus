...
export default function Team() {
  ...
  return (
    ...
    <div className=' grid grid-cols-3 mt-9 gap-4 max-sm:grid-cols-1'>
      {
        teams.map((teamMember,index) =>{
          ...
          <div className=' row-span-1 flex justify-between max-sm:flex-col max-sm:items-center max-sm:text-center'>
          ...
          <div className=' border-t border-black pt-3 max-sm:text-center'>
